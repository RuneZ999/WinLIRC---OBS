...
Menu, Tray, Tip, OBS WinLIRC Reciver
...
IfWinExist, OBS 24.
{
	Controlsend,,^+{F11},ahk_class Qt5QWindowIcon ; This class name is for OBS Studio.
}
else
{
	guidisp("OBS NOT running",0, 0)
...
IfWinExist, OBS 24.
{
	Controlsend,,^+{F12},ahk_class Qt5QWindowIcon ; This class name is for OBS Studio.
}
else
{
	guidisp("OBS NOT running",0, 0)
...
IfWinExist, OBS 24.
{
	Controlsend,,^+o,ahk_class Qt5QWindowIcon ; This class name is for OBS Studio.
}
else
{
	guidisp("OBS NOT running",0, 0)
...
IfWinExist, OBS 24.
{
	Controlsend,,^+n,ahk_class Qt5QWindowIcon ; This class name is for OBS Studio.
}
else
{
	guidisp("OBS NOT running",0, 0)
...
IfWinExist, OBS 24.
{
	Controlsend,,^+z,ahk_class Qt5QWindowIcon ; This class name is for OBS Studio.
}
else
{
	guidisp("OBS NOT running",0, 0)
